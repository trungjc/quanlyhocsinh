...
{
    public partial class EditAdminAddRoles : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            string Id = "";
            if (Page.RouteData.Values["Id"] != null)
                Id = Page.RouteData.Values["Id"].ToString().Replace(",", "");
        ...
        protected void initControl(string Id)
        {
            ...
            {
                error.Text = "Lỗi: Lựa chọn người dùng trước khi thêm quyền";
            }
        }
        #endregion

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditAnnounce.ascx.cs" Inherits="CMS.Client.Admin.EditAnnounce" %>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td id="Td2" style="text-align: center">
                                    <asp:HyperLink ID="btn_editpage" runat="server" CssClass="toolbar" NavigateUrl="~/Admin/listannounce/Default.aspx">
                                ...
                                <td id="Td1" style="text-align: center">
                                    <asp:HyperLink ID="HyperLink1" runat="server" CssClass="toolbar" NavigateUrl="~/Admin/editannounce/Default.aspx">
            ...
            <td class="txt-from-taomoi" width="70%">
                <table width="100%" border="0" cellspacing="0" cellpadding="5">
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlCateAnnounce" runat="server" Width="300px" AppendDataBoundItems="True">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="txt-from-taomoi">
                            <asp:Label ID="Label3" runat="server" Text="Ảnh thông báo  (nếu có) :"></asp:Label>
                        </td>
                        <td>
                            <asp:FileUpload ID="file_image_thumb" runat="server" Width="400px"  onchange="PreviewImage();" />
                    ...
                    <tr>
                        <td class="txt-from-taomoi">
                            <asp:Label ID="Label11" runat="server" Text="File đính kèm (nếu có) :"></asp:Label>
                        </td>
                        <td>
...
<asp:HiddenField ID="hddAnnounceID" runat="server" />
...
<asp:HiddenField ID="hddParentAnnounceID" runat="server" />

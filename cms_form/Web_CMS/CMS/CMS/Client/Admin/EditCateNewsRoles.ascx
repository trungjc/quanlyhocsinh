<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditCateNewsRoles.ascx.cs"
    Inherits="CMS.Client.Admin.EditCateNewsRoles" %>
                            ...
                            <tr>
                                ...
                                <td id="Td2" style="text-align: center">
                                    <asp:HyperLink ID="btn_editpage" runat="server" CssClass="toolbar">
                                        <asp:ImageButton ID="ImageButton2" runat="server" CssClass="toolbar" ImageUrl="~/images/Admin_Theme/Icons/icon-32-menu.png"
                                            OnClientClick="javascript:history.back()" /><br/>
                                        Danh mục
                                    </asp:HyperLink>
                                </td>
    ...
    <div style="width: 98%; padding-left: 10px;">
        <telerik:RadGrid ID="RadGrid1" runat="server" PageSize="200" AllowPaging="True" GridLines="None"
            ...
            <MasterTableView Width="100%" DataKeyNames="Roles_ID">
                <Columns>
                    <telerik:GridBoundColumn HeaderText="rID" HeaderButtonType="TextButton" DataField="Roles_ID"
                        UniqueName="Roles_ID" Resizable="False" Visible="false">
                    ...
                    <telerik:GridBoundColumn SortExpression="Roles_Name" HeaderText="Tên nhóm quyền"
                        HeaderButtonType="TextButton" DataField="Roles_Name" UniqueName="Roles_Name"
                        Resizable="False">
                        <HeaderStyle Height="30px" />
                    </telerik:GridBoundColumn>

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditImageSlideShow.ascx.cs" Inherits="CMS.Client.Admin.EditImageSlideShow" %>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td id="Td2" style="text-align: center">
                                    <asp:HyperLink ID="btn_editpage" runat="server" CssClass="toolbar" NavigateUrl="~/Admin/ListImageSlideShow/Default.aspx">
                                ...
                                <td id="Td1" style="text-align: center">
                                    <asp:HyperLink ID="HyperLink1" runat="server" CssClass="toolbar" NavigateUrl="~/Admin/EditImageSlideShow/Default.aspx">

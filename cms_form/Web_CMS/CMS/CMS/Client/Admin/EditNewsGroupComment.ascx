<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditNewsGroupComment.ascx.cs"
    Inherits="CMS.Client.Admin.EditNewsGroupComment" %>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="5">
        ...
        <tr>
            <td colspan="2" class="txt-from-taomoi">
                <telerik:RadEditor ID="txtContent" runat="server" Height="250px" Width="570px" ToolsFile="~/RadControls/Editor/BasicTools.xml"
                    SkinID="BasicTools" EnableEmbeddedSkins="true" Skin="Simple" EditModes="Design, Html">
                </telerik:RadEditor>
            </td>
        </tr>
        <tr>

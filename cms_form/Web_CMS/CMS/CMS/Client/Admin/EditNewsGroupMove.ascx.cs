...
{
    public partial class EditNewsGroupMove : System.Web.UI.UserControl
    {
        ...
        protected void BindToCateNewsGroup()
        {
            ...
            datatable = _catenewsgroupBSO.GetCateNewsGroupNewAll();
        ...
        protected void ddlCateNewsGroup_SelectedIndexChanged(object sender, Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs e)
        {

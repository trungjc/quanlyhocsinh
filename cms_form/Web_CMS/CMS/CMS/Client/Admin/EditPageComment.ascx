<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditPageComment.ascx.cs" Inherits="CMS.Client.Admin.EditPageComment" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5" >
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtTitle" runat="server" Width="477px" CssClass="txt-form-create-input"></asp:TextBox>

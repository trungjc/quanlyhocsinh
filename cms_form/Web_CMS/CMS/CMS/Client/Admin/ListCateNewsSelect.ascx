<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ListCateNewsSelect.ascx.cs"
    Inherits="CMS.Client.Admin.ListCateNewsSelect" %>
                ...
                <ItemTemplate>
                    <div style="float: left;">
                        <div class="icon_admin">
                            <asp:HyperLink ID="HyperLink5" runat="server" NavigateUrl='<%# "~/Admin/Group/listcatenews/" + Eval("GroupCate") + "/Default.aspx" %>'

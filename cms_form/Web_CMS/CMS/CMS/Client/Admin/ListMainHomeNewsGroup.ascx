<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ListMainHomeNewsGroup.ascx.cs"
    Inherits="CMS.Client.Admin.ListMainHomeNewsGroup" %>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td id="Td6" style="text-align: center">
                                    <asp:HyperLink ID="HyperLink1" runat="server" CssClass="toolbar" NavigateUrl="~/Admin/ListMainHomeNewsSelect/Default.aspx">
                        ...
                        <asp:GridView ID="grvNewsGroup" runat="server" AutoGenerateColumns="False" Width="100%"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Chức năng">
                                    <ItemStyle HorizontalAlign="Center" CssClass="gridviewCellBottom gridviewCellRight" />
                                    <ItemTemplate>
                                        <asp:ImageButton ID="btn_default" runat="server" CommandName="_default" CommandArgument='<%# Eval("NewsGroupID") %>'

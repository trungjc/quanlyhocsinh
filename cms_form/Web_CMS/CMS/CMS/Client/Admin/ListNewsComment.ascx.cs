...
{
    public partial class ListNewsComment : System.Web.UI.UserControl
    {
        ...
        protected void btn_list(object sender, EventArgs e)
        {
            ...
            if (hddGroup.Value == "2")
                Response.Redirect("~/Admin/listcompany/Default.aspx");
            if (hddGroup.Value == "3")
                Response.Redirect("~//Admin/listannounce/Default.aspx");
        }

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ListPageComment.ascx.cs"
    Inherits="CMS.Client.Admin.ListPageComment" %>
        ...
        <tr>
            <td>
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                <asp:GridView ID="grvPageComment" runat="server" AutoGenerateColumns="False" OnRowCommand="grvPageComment_RowCommand"
                    OnRowDataBound="grvPageComment_RowDataBound" Width="100%" AllowPaging="True"
                    OnPageIndexChanging="grvPageComment_PageIndexChanging" CssClass="gridviewBorder"
                    CellPadding="4" ForeColor="#333333" GridLines="None">
                    <Columns>
                        <asp:BoundField DataField="CommentPageID" HeaderText="ID">
                        ...
                        <asp:BoundField DataField="PageTitle" HeaderText="Tin được đ&#225;nh gi&#225;">
                            <ItemStyle HorizontalAlign="Center" CssClass="gridviewCellBottom gridviewCellRight" />
                            <HeaderStyle CssClass="gridviewCellBottom gridviewCellRight" HorizontalAlign="Center"
                                Width="100px" />
                        </asp:BoundField>
                        ...
                        <asp:TemplateField HeaderText="Chức năng">
                            <ItemStyle HorizontalAlign="Center" CssClass="gridviewCellBottom gridviewCellRight" />
                            <ItemTemplate>
                                <asp:ImageButton ID="btn_edit" runat="server" CommandName="_edit" CommandArgument='<%# Eval("CommentPageID") %>'
                                    ImageUrl="~/images/Admin_Theme/images/btn_edit.png" ToolTip="Sửa chữa" />
                                &nbsp;<asp:ImageButton ID="btn_delete" runat="server" CommandName="_delete" CommandArgument='<%# Eval("CommentPageID") %>'

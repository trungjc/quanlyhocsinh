<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="editemail.ascx.cs" Inherits="CMS.Client.Admin.editemail" %>
    ...
    <table width="100%" border="0" cellpadding="5" cellspacing="0">
        ...
        <tr>
            ...
            <td style="height: 24px">
                ...
                <asp:RequiredFieldValidator ForeColor="Red" ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtName"
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ForeColor="Red" ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtEmailAddress"
                    ErrorMessage="Địa chỉ Email không chính xác" Font-Bold="False" Font-Size="10px"

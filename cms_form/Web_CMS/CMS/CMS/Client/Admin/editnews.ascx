<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="editnews.ascx.cs" Inherits="CMS.Client.Admin.editnews" %>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td id="Td2" style="text-align: center">
                                    <asp:HyperLink ID="btn_editpage" runat="server" CssClass="toolbar" NavigateUrl="~/Admin/listnews/Default.aspx">
                                ...
                                <td id="Td1" style="text-align: center">
                                    <asp:HyperLink ID="HyperLink1" runat="server" CssClass="toolbar" NavigateUrl="~/Admin/editnews/Default.aspx">
                ...
                <table width="100%" border="0" cellpadding="5" cellspacing="0">
                    ...
                    <tr>
                        <td class="txt-from-taomoi" style="height: 22px">
                            <asp:Label ID="Label3" runat="server" Text="Ảnh đại diện  (ảnh nhỏ) :"></asp:Label>
                        </td>
                    ...
                    <tr>
                        <td class="txt-from-taomoi" style="height: 22px">
                            <asp:Label ID="Label11" runat="server" Text="Ảnh đại diện  (ảnh to) :"></asp:Label>
                        </td>
                        <td style="height: 22px">
                    ...
                    <tr>
                        <td colspan="2" class="txt-from-taomoi">
                            <telerik:RadEditor ID="txtRadShort" Skin="Default" runat="server" DeleteFlashPaths="~/UserFile/Media"
                                ...
                                UploadImagesPaths="~/UserFile/Images" UploadMediaPaths="~/UserFile/Media" Width="500px"

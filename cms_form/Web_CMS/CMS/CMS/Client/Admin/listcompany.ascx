<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="listcompany.ascx.cs"
    Inherits="CMS.Client.Admin.listcompany" %>
                    ...
                    <table class="toolbar">
                        <tbody>
                            <tr>
                                ...
                                <td id="Td1">
                                    <asp:HyperLink ID="HyperLink1" runat="server" CssClass="toolbar" NavigateUrl="~/Admin/Group/listnewscomment/2/Default.aspx">
                                ...
                                <td id="Td2" style="text-align: center">
                                    <asp:HyperLink ID="btn_editpage" runat="server" CssClass="toolbar" NavigateUrl="~/Admin/editcompany/Default.aspx">

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="listnews.ascx.cs" Inherits="CMS.Client.Admin.listnews" %>
                    ...
                    <table class="toolbar">
                        <tbody>
                            <tr>
                                ...
                                <td id="Td1">
                                    <asp:HyperLink ID="HyperLink1" runat="server" CssClass="toolbar" NavigateUrl="~/Admin/Group/listnewscomment/1/Default.aspx">
                                ...
                                <td id="Td2" style="text-align: center">
                                    <asp:HyperLink ID="btn_editpage" runat="server" CssClass="toolbar" NavigateUrl="~/Admin/editnews/Default.aspx">
        ...
        <tr>
            <td>
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                <asp:GridView ID="grvNews" runat="server" AutoGenerateColumns="False" Width="100%"
                    AllowPaging="True" OnPageIndexChanging="grvNews_PageIndexChanging" OnRowCommand="grvNews_RowCommand"
                    OnRowDataBound="grvNews_RowDataBound" CssClass="gridviewBorder" PageSize="15"
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="NewsID" DataNavigateUrlFormatString="~/Admin/listnewscomment/1/{0}/Default.aspx"
                        ...
                        <asp:TemplateField HeaderText="Chức năng">
                            <ItemStyle HorizontalAlign="Center" CssClass="gridviewCellBottom gridviewCellRight" />
                            <ItemTemplate>
                                <asp:ImageButton ID="btn_view" runat="server" CommandName="_view" CommandArgument='<%# Eval("NewsID") %>'
                                    ImageUrl="~/images/Admin_Theme/images/btn_view.png" />&nbsp;
                                <asp:ImageButton ID="btn_edit" runat="server" CommandName="_edit" CommandArgument='<%# Eval("NewsID") %>'
                                    ImageUrl="~/images/Admin_Theme/images/btn_edit.png" />&nbsp;
                                <asp:ImageButton ID="btn_delete" runat="server" CommandName="_delete" CommandArgument='<%# Eval("NewsID") %>'

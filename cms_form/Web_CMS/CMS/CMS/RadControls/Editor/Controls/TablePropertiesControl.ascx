						...
						<fieldset>
							...
							<table width="100%">
								<tr>
									...
									<td>
										<input class="Text" id="<%=this.ClientID%>_tableWidth" style="WIDTH: 50px" type="text" maxlength="6">
									</td>
								...
								<tr>
									...
									<td>
										<input class="Text" id="<%=this.ClientID%>_tableHeight" style="WIDTH: 50px" type="text" maxlength="6">
									</td>
									<td class="Label" nowrap>px, %</td>
								</tr>
							</table>
									...
									<td class="Label" valign="center" width="50%">
										<table>
											...
											<tr>
												...
												<td>
													<telerik:SpinBox id="cellSpacingSpinBox" runat="server"/>
												</td>
											</tr>
											<tr>
												<td class="Label" width="50%" nowrap>
												...
												<td>
													<telerik:SpinBox id="cellPaddingSpinBox" runat="server"/>
												</td>
											</tr>
											<tr>
												<td class="Label" width="50%" nowrap><script>localization.showText('Id');</script></td>
												<td><input class="Text" type="text" id="<%=this.ClientID%>_idHolder"/></td>
											</tr>
										</table>
									</td>
								</tr>

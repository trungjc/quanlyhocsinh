	...
	<tr>
		<th align="left" valign="bottom">
			<telerik:tabcontrol id="TabHolder" runat="server" ResizeControlId="MainTable">
				...
				<telerik:tab image="Dialogs/TabIcons/TemplateTab2.gif" text="<script>localization.showText('Tab2HeaderText');</script>" onclientclick="ConfigureUploadPanel();" elementid="TemplateUploader"/>
			</telerik:tabcontrol>
		</th>
	</tr>
	<tr>

...
<table cellspacing="0" cellpadding="2" border="1" bordercolor="#000000" style="font:normal 10px Arial">
	...
	<tr>
		...
		<td>Design button - Switches r.a.d.editor into Design Mode.</td>
		<td>-</td>
	</tr>
	<tr>
		<td align="middle"><img src="<%= this.SkinPath %>Img/ButtonHtml.gif"></td>
		<td>HTML button - Switches r.a.d.editor into HTML Mode.</td>
		<td>-</td>
	</tr>
	<tr>
		<td align="middle"><img src="<%= this.SkinPath %>Img/ButtonPreview.gif"></td>
		<td>Preview button - Switches r.a.d.editor into Preview Mode.</td>
		<td>-</td>
	</tr>
	...
	<tr>
		...
		<td>Toggle Screen Mode - Switches r.a.d.editor into Full Screen Mode.</td>
		<td>-</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>Print button - Prints the contents of the r.a.d.editor or the whole web page.</td>
		<td>Ctrl+P</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>About Dialog - Shows the current version and credentials of r.a.d.editor.</td>
		<td>-</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>Insert Table button - Inserts a table in the r.a.d.editor.</td>
		<td>-</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>Insert horizontal line (e.g. horizontal ruler) button - Inserts a horizontal 

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AlbumsView.aspx.cs" Inherits="Fomusa.Client.Modules.Albums.AlbumsView" %>
...
<head id="Head1" runat="server">
    <title>Thư viện hình ảnh</title>
        <link rel="stylesheet" href="<%=Page.ResolveUrl("~/")%>CSS/style_albums.css" type="text/css" media="screen"/>
        <style>
			body{
				background:#ddd;
				font-family:Arial;
    ...
    <div>
		...
		<div id="msg_slideshow" class="msg_slideshow">
			...
			<div id="msg_thumbs" class="msg_thumbs"><!-- top has to animate to 0px, default -230px -->
                ...
                <asp:Literal ID="ltlAlbums" runat="server"></asp:Literal>
                    ...
                    if ($thumb.length) {
                        ...
                        if ($currentImage.length) {
                            $currentImage.fadeOut(function () {
                                ...
                                }).attr('src', source).attr('style', 'width:600px;');
                            });
                        }
                        else {
                            $('<img />').load(function () {

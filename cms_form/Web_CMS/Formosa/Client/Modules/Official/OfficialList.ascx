<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OfficialList.ascx.cs" Inherits="Fomusa.Client.Modules.Official.OfficialList" %>
    ...
    <div class="main_home">
        ...
        <div style="padding: 0 10px; vertical-align: top">
            <asp:DataList ID="DataList1" runat="server" OnItemDataBound="DataList1_ItemDataBound">
                <ItemTemplate>
                    <div class="main_title_catenews" style="padding-top: 10px;">
                        <asp:HyperLink ID="hyperLink1" runat="server" NavigateUrl='<%#"~/Category/"+ Eval("GroupCate") +"/"+Eval("CateNewsID") +"/Default.aspx" %>'><%#Eval("CateNewsName")%></asp:HyperLink></div>
                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" Width="635px"
                        CssClass="gridviewBorder_doc" CellPadding="4" ForeColor="#333333" GridLines="None"
                        Font-Size="11px" PageSize="10">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:Image ID="Image1" runat="server" ImageUrl="~/images/bullet3.gif" />

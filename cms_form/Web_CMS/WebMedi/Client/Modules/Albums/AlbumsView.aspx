<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AlbumsView.aspx.cs" Inherits="WebMedi.Client.Modules.Albums.AlbumsView" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" href="<%=Page.ResolveUrl("~/")%>CSS/style_albums.css" type="text/css"
        media="screen" />
    <style type="text/css">
        body
        {

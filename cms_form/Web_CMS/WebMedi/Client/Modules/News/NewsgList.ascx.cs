    ...
    public partial class NewsgList : System.Web.UI.UserControl
    {
        ...
        private void GetNewsGroupByCate(int cId)
        {
            ...
            while (catenews.ParentNewsID != 0)
            {
                ...
                s1 = "<a href='" + ResolveUrl("~/") + "catenewsg/" + catenews.GroupCate + "/" + catenews.CateNewsID + "/" + GetString(catenews.CateNewsName) + ".aspx' class='content_Text_Cat'>" + catenews.CateNewsName + "</a> &nbsp;<img src='" + ResolveUrl("~/") + "images/icon_arrows1.png'>&nbsp;" + s1;
            }
